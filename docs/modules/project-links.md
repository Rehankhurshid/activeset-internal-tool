...
- **Re-labelling client status from the card must not `touch`** (ProjectCard.tsx l.138-150): `clientFacing.lastUpdateAt` drives the stale-portal nudge.
