...
description: Core project context and technology stack information
...
Key Modules
Link Management: CRUD for project links with drag-and-drop reordering
Proposal Generator: AI-powered proposal creation with PDF export
Audit Dashboard: Content auditing with LanguageTool integration
Sitemap Scanner: Automated sitemap discovery and analysis
Code Conventions
